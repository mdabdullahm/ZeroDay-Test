...
const accreditationData = [
  {
    ...
    logo: "/gic-logo.png", 
    id: "24-F-0312",
    link: "https://www.iafcertsearch.org/certification/HcqevFBag526RbKL9N50L0Xs" 
  },
  {
    name: "IAS Accredited",
    logo: "/ias-logo.png", 
...
const Achievements = () => {
  return (
    <section className="relative bg-black py-20 lg:py-28 overflow-hidden border-t border-green-500/10">
      ...
      {/* ১. ব্যাকগ্রাউন্ড ম্যাট্রিক্স গ্রিড */}
      ...
      <div className="max-w-full mx-auto px-6 lg:px-20 relative z-10">
                ...
                <div className="bg-white rounded-[2rem] p-10 h-72 flex flex-col items-center justify-center relative overflow-hidden transition-all duration-500 group-hover:-translate-y-3 shadow-[0_10px_30px_rgba(0,0,0,0.5)] group-hover:shadow-[0_20px_50px_rgba(34,197,94,0.2)]">
                  ...
                  <div className="relative z-10 flex-1 flex items-center justify-center mb-6">
                    <img 
                      src={item.logo} 
                      alt={item.name} 
                      className="max-h-24 w-auto object-contain transition-all duration-500 scale-90 group-hover:scale-105"
                      onError={(e) => (e.currentTarget.style.display = 'none')}
                    />
                  </div>

                  {/* টাইটেল এরিয়া */}
                  <div className="relative z-10 text-center border-t border-zinc-200 pt-6 w-full">
                    ...
                    <p className="text-[9px] font-mono text-zinc-400 mt-2 tracking-widest flex items-center justify-center gap-1">
                      {item.id} <Zap size={8} className="text-green-500 opacity-0 group-hover:opacity-100 transition-opacity" />
                    </p>
                  </div>
                </div>
              </a>
        ...
        <div className="mt-20 py-6 border-y border-white/5 flex flex-wrap justify-center items-center gap-4 md:gap-8 group">
           ...
           <div className="hidden md:block w-1.5 h-1.5 rounded-full bg-green-900"></div>
           <div className="flex items-center gap-2 text-[10px] font-mono text-gray-100 uppercase tracking-widest">
