    ...
    <section className="relative py-10 lg:py-15 bg-black overflow-hidden border-t border-green-500/5 mt-[-1px]">
      ...
      <div className="max-w-full mx-auto px-6 lg:px-20 relative z-10">
        ...
        >
          ...
          <div className="text-center relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
              {/* Primary Action */}
              <Link href="https://zerodaytest.com/docs" className="group relative w-full sm:w-auto px-12 py-6 bg-green-600 hover:bg-green-500 text-black font-black rounded-2xl transition-all shadow-[0_0_40px_rgba(34,197,94,0.4)] hover:shadow-[0_0_60px_rgba(34,197,94,0.6)] hover:-translate-y-2 active:scale-95 text-base uppercase tracking-widest overflow-hidden">
              ...
              <a
                ...
                className="w-full sm:w-auto px-12 py-6 border-2 border-white/10 hover:border-green-500/50 hover:bg-green-500/5 text-white font-black rounded-2xl transition-all backdrop-blur-md text-base uppercase tracking-widest flex items-center justify-center gap-3 cursor-pointer"
              >
                REQUEST_A_QUOTE <Lock size={20} className="text-green-800" />
              </a>
            </div>

            {/* Trust Markers */}
            <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 opacity-90 border-t border-white/5 pt-12">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <span className="text-[10px] font-mono text-gray-400 uppercase">Global Operation</span>
              </div>
              <div className="flex flex-col items-center gap-2">
                <Cpu size={24} className="text-green-500" />
                <span className="text-[10px] font-mono text-gray-400 uppercase">AI-Powered Audit</span>
              </div>
              <div className="flex flex-col items-center gap-2">
                <Zap size={24} className="text-green-500" />
                <span className="text-[10px] font-mono text-gray-400 uppercase">Rapid Response</span>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        <div className="mt-12 flex justify-center items-center gap-6">
          ...
          <p className="text-[9px] font-mono text-gray-500 uppercase tracking-[0.5em] whitespace-nowrap">
